...
void View::Camera::set_viewport_width(coord_t new_width) {
    viewport_width = new_width;
}

void View::Camera::set_viewport_height(coord_t new_height) {
...
void View::Camera::set_center(coord_t x, coord_t y) {
