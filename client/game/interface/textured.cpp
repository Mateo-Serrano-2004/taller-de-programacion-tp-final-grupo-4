...
bool View::Textured::is_texture_drawn() const {
    return draw_texture;
}

SDL2pp::Optional<SDL2pp::Rect> View::Textured::get_texture_slice() const {
    return texture_slice;
}

void View::Textured::set_draw_texture(bool new_draw_texture) {
    draw_texture = new_draw_texture;
}

void View::Textured::set_texture(Shared<SDL2pp::Texture> new_texture) {
    texture = new_texture;
}
...
void View::Textured::reset_texture_slice() {
