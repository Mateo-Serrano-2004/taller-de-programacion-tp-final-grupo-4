...
#include "common/event/join_game_event.h"
...
//     GameEventVariant, SendUsernameEvent, CreateGameEvent,
//     MapRequestEvent, JoinGameEvent, ListGamesEvent
// >;

using GameEventVariant = std::variant<
    Model::QuitEvent, Model::MovementEvent, Model::RotationEvent
>;

using EventVariant = std::variant<
    GameEventVariant,
    Model::UsernameEvent, Model::CreateGameEvent, Model::JoinGameEvent
>;
